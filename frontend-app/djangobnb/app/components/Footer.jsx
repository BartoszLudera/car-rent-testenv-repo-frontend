...
export default function Footer() {
  return (
    <footer className="relative bg-blueGray-200 pt-32 pb-6">
        <hr></hr>
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full lg:w-6/12 px-4">
            <h4 className="text-3xl font-semibold text-blueGray-700">Kontakt:</h4>
            <h5 className="text-lg mt-0 mb-2 text-blueGray-600">
              W przypadku jakichkolwiek pytań, prosimy o kontakt: XXXXX@XXX.pl Odpowiadamy do 1h.
            </h5>
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex flex-wrap items-top mb-6">
              <div className="w-full lg:w-4/12 px-4 ml-auto">
                <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Skrót linków</span>
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-blueGray-500 font-semibold py-1">
              ...
              <a className="text-blueGray-500 hover:text-gray-800" target="_blank" rel="noopener noreferrer"> LynxByte</a> 
