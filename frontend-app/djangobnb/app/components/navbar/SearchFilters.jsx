      ...
      <div className="hidden lg:block">
        <div className="flex flex-row items-center justify-between">
          <div className="cursor-pointer h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
            <p className="text-xs font-semibold">Model samochodu</p>
            <p className="text-sm">Dodaj model</p>
          </div>

          <div className="cursor-pointer w-[250px] h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
            <p className="text-xs font-semibold">Lokalizacja</p>
            <p className="text-sm">Lokalizacja samochodu</p>
          </div>

          <div className="cursor-pointer h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
            <p className="text-xs font-semibold">Data początkowa</p>
            <p className="text-sm">Dodaj datę</p>
          </div>

          <div className="cursor-pointer h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
            <p className="text-xs font-semibold">Data końcowa</p>
            <p className="text-sm">Dodaj datę</p>
          </div>
        </div>
      </div>
